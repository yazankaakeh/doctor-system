...
@section('layoutContent')
    <div class="layout-wrapper layout-content-navbar {{ $isMenu ? '' : 'layout-without-menu' }}">
        <div class="layout-container">
            ...
            @if ($isMenu)
                @includeIf('theme::user/layouts/sections/menu/verticalMenu')
            @endif
            ...
            <div class="layout-page">
                ...
                <!-- BEGIN: Navbar-->
                @if ($isNavbar)
                    @includeIf('theme::user/layouts/sections/navbar/navbar')
                @endif
                <!-- END: Navbar-->
                    ...
                    @if ($isFlex)
                        <div class="{{ $container }} d-flex align-items-stretch flex-grow-1 p-0">
                            @else
                                ...
                                <!-- Footer -->
                                @if ($isFooter)
                                    @includeIf('theme::user/layouts/sections/footer/footer')
                                @endif
                                <!-- / Footer -->
