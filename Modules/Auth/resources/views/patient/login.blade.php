...
@section('title', trans('auth::auth.patient_login'))
            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h4 class="mb-1 pt-2">{{ trans('auth::auth.patient_login') }}</h4>
                        <p class="mb-4">{{ trans('auth::auth.patient_login_subtitle') }}</p>

                        <!-- Demo Credentials -->
                        <x-auth::demo-credentials user-type="patient" />
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('patient.login.post') }}" method="POST">
                            @csrf
                        ...
                        <p class="text-center">
                            <span>{{ trans('auth::auth.new_on_platform') }}</span>
